...
public class PTSClientManager extends ClientTCP{
	...
	public void login(String username) throws IOException{
		...
		PTS ptsTemp=new PTS();//TODO: colocar isto na classe In que fica dentro da Log
		ptsTemp.setType("in");
	...
	public void register(String username) throws IOException{
		...
		PTS ptsTemp=new PTS();//TODO: colocar isto na classe On que fica dentro da Log
		ptsTemp.setType("on");
		ptsTemp.setValue(username);
	...
	protected void check(){
		// TODO: checar todas as respostas do servidor aqui usando getReceived() e atualizar as listas
	}
